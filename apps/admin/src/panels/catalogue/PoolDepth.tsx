  ...
  return (
    <div style={{ display: 'flex', flexDirection: 'column', gap: 20 }}>
      ...
      <div style={{ display: 'flex', alignItems: 'center', gap: 12 }}>
        <span style={{ fontSize: 10, color: T.textDim, fontFamily: T.mono, textTransform: 'uppercase' }}>sort</span>
...
function DataRow({ row }: {
  ...
  return (
    <div style={{
      ...
      <span style={{ color, textAlign: 'right', fontSize: 10, textTransform: 'uppercase' }}>{row.status}</span>
    </div>
  )
}
